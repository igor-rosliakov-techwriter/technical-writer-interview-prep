...
Шпаргалка по базовым IT-темам для собеседований технического писателя.

Каждый вопрос содержит два полностью отдельных языковых блока:
...
## 2. Frontend и backend / Frontend vs backend
...
## 3. Что происходит после ввода URL в браузере? / What happens when you enter a URL?
...
## 12. Основные HTTP-методы / Main HTTP methods
...
## 18. Как HTTP передает изображения, аудио и видео? / How does HTTP transfer media?
